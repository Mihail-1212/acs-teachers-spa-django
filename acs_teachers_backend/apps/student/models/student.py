...
class Student(models.Model):
	...
	related_name_single = 'student'

	option_num = models.IntegerField(blank=True, verbose_name=_('student option number in group'))

	user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, verbose_name=_('user'), related_name=related_name_single)
